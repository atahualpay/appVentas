...
@Table(name = "tablaClientes") // Entidad relacionada con la Tabla
public class ClienteModel {

    @Id //Define la primera variable declarada como identificador
    @GeneratedValue(strategy = GenerationType.IDENTITY) //Genera el identificador como autoincremental
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, clienteModel.id) && Objects.equals(nombre, clienteModel.nombre) && Objects.equals(email, clienteModel.email) && Objects.equals(telefono, clienteModel.telefono);
    }
